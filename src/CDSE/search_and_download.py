...
# -------------------------------------------------------------------------- #
    ...
    if sensor == 'SENTINEL-1':
        ...
        if relative_orbit is not None:
            querySTR_rel_orbit = " and " + f"Attributes/OData.CSC.IntegerAttribute/any(att:att/Name eq 'relativeOrbitNumber' and att/OData.CSC.StringAttribute/Value eq '{relative_orbit}')"
        else:
            querySTR_rel_orbit = ""
